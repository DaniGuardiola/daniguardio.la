...
- On Twitter, this meant switching from "@daniguardiolame" to "@daniguardio_la".
- On Instagram, which allows dots on the account names, I was able to switch from "@daniguardiola.me" to "@daniguardio.la".
- I was already using "DaniGuardiola" in other networks such as DEV or Medium, so no change was needed there.
